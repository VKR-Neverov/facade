...
func (r *queryResolver) Invoices(ctx context.Context, filter *model.InvoicesFilter, page int, perPage int) (*model.InvoicesPagination, error) {
	...
	invoices, err := r.invoicesService.ListInvoices(ctx, listInvoicesFilter, uint64(page), uint64(perPage))
	if err != nil {
